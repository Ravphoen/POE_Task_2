...
namespace Gade_Assignment_1
{
    ...
    {
        public MeleeUnit(int xxpos, int yypos, int hhealth, int aattack, int aattack_range, int tteam, string ssymbol, bool aattacking, string uunit_name)
        {
            this.xpos = xxpos;
            this.ypos = yypos;
            this.health = hhealth;
